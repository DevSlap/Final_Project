...
def get_train_args():
    ...
    parser.add_argument('--c_len',
                        type=int,
                        default=400,
                        help='Max number of words in a paragraph')
    parser.add_argument('--q_len',
                        type=int,
                        default=50,
                        help='Max number of words in a question')
...
def get_test_args():
    ...
    parser.add_argument('--num_test_to_save',
                        type=int,
                        default=1000,
                        help='Number of test results to save in the XML file')
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--rnn_type',
                        type=str,
                        default='LSTM',
                        choices=('RNN', 'LSTM', 'GRU','GORU', 'URNN'),
